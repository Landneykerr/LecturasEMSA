    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            try {
                ...
                this.FcnInformacion.updateMunicipios(jsonObj.getJSONArray("Municipios"));
                this.FcnInformacion.updateAnomalias(jsonObj.getJSONArray("Anomalias"));
                this.FcnInformacion.updateCriticas(jsonObj.getJSONArray("Criticas"));
                this.FcnInformacion.updateUsos(jsonObj.getJSONArray("Usos"));
                this.FcnInformacion.updateMensajes(jsonObj.getJSONArray("Mensajes"));
                this.FcnInformacion.updateFiltroMacro(jsonObj.getJSONArray("SiglasMacro"));
                this.FcnInformacion.updateMedidoresNC(jsonObj.getJSONArray("SiglasMedidoresNC"));
