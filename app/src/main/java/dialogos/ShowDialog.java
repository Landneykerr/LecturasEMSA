...
public class ShowDialog {
    ...
    public void showLoginDialog(Context _ctx, int _ciclo, int _municipio, String _ruta) {

        SQLite  FcnSQL = new SQLite(_ctx);
        this.totalRuta          = FcnSQL.CountRegistrosWhere("maestro_clientes","id_ciclo = "+_ciclo+" AND id_municipio = "+_municipio+" AND ruta='"+_ruta+"'");
        this.totalPendientes    = FcnSQL.CountRegistrosWhere("maestro_clientes","id_ciclo = "+_ciclo+" AND id_municipio = "+_municipio+" AND ruta='"+_ruta+"' AND estado = 'P'");
        this.totalCola          = FcnSQL.CountRegistrosWhere("maestro_clientes","id_ciclo = "+_ciclo+" AND id_municipio = "+_municipio+" AND ruta='"+_ruta+"' AND estado = 'T'");
        this.totalEnviadas      = FcnSQL.CountRegistrosWhere("maestro_clientes","id_ciclo = "+_ciclo+" AND id_municipio = "+_municipio+" AND ruta='"+_ruta+"' AND estado = 'E'");
