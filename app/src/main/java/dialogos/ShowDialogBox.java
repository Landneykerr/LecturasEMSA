...
public class ShowDialogBox implements global_var {
    ...
    public void showDialogBox(Context _ctx, int _typeDialog, String _tittle, String _message) {
        ...
        switch (_typeDialog){
            case DIALOG_ERROR:
                this._imgIcono.setImageResource(R.drawable.ic_error_dialog);
                break;

            case DIALOG_WARNING:
                this._imgIcono.setImageResource(R.drawable.ic_warning_dialog);
                break;

            case DIALOG_INFORMATIVE:
                this._imgIcono.setImageResource(R.drawable.ic_inf_dialog);
                break;
